...
syn match   gasOpcode_8086_Base		/\<j\(e\|ne\|a\|na\|ae\|b\|be\|nb\|nbe\|g\|ge\|ng\|nge\|l\|le\|\|z\|nz\|c\|nc\|d\|nd\|o\|no\|p\|np\|s\|ns\)[bwlq]\?\>/
...
" miss out on bl so that x86's bl isn't highlighted as an opcodopcode
syn keyword gasOpcode_ARM_THUMB         bleq blne blcs blhs blcc bllo blmi
syn keyword gasOpcode_ARM_THUMB         blpl blvs blvc blhi blls blge bllt blgt
syn keyword gasOpcode_ARM_THUMB         blle blal
" miss out on bx so that x86's bx isn't highlighted as an opcodopcode
